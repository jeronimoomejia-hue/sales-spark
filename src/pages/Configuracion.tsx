              ...
              <Card variant="glass" className="p-6">
                ...
                <div className="flex items-center gap-6 mb-8">
                  <div className="relative">
                    <div className="w-24 h-24 rounded-full bg-gradient-party flex items-center justify-center text-white text-3xl font-bold">
                      JP
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Input defaultValue="juan.perez@email.com" type="email" />
                  </div>
                  <div>
                    <label className="text-sm font-medium text-muted-foreground mb-2 block">
                      Teléfono
              ...
              <Card variant="glass" className="p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { title: "Próximo cierre", desc: "Recordatorios antes de cada cierre de caja", enabled: true },
                    ...
                    { title: "Promociones y ofertas", desc: "Información sobre nuevos eventos", enabled: false },
                  ].map((item, index) => (
